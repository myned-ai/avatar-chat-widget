...
<div class="widget-root" data-drawer-state="avatar-focus">
  ...
  <div class="header-layer">
    ...
    <div class="header-buttons">
      ...
      <button id="viewModeBtn" class="control-btn" aria-label="Toggle view mode" title="Switch view">
        ...
        <!-- Avatar icon (shown in text-focus mode) -->
  ...
  <div class="avatar-section" id="avatarSection">
    ...
    <!-- Subtitles (only visible in avatar-focus mode) -->
